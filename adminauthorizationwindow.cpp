...
AdminAuthorizationWindow::AdminAuthorizationWindow(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::AdminAuthorizationWindow)
{
    ui->setupUi(this);
...
void AdminAuthorizationWindow::on_pushButton_clicked()
{
    ...
    {
        QMessageBox::warning(this, QString("Access Denied"), QString("Access not allowed. Please check your credentials."));
